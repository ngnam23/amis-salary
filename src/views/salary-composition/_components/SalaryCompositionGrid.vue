  ...
  <div class="flex flex-col w-full h-full">
    <div class="flex items-center justify-between h-9 mb-[14px]">
      <div class="flex items-center">
        <div
          v-tooltip.bottom="{ value: 'Quay lại', showDelay: 100 }"
      ...
      <div v-if="type === 'update'" class="flex items-center gap-2">
        ...
        <div class="card flex justify-center">
          ...
          />
          <Menu ref="menuMore" id="overlay_menu" :model="actionMoreList" :popup="true">
            <template #item="{ item }">
              <div
    ...
    <div class="w-full flex-1 overflow-y-hidden">
      ...
      >
        <MsButtonBase label="Hủy bỏ" class="w-20" @click="handleBack" />
        <MsButtonBase
          label="Lưu và thêm"
...
const { handleSubmit, setFieldValue, values, resetForm, meta } = useForm({
        ...
        if (detail) {
          resetForm({
            values: {
              ...
              selectedOrganizationIds: checkValueSelectedOrganizationIds(
                detail?.selectedOrganizationIds,
              ),
            },
          })
        }
